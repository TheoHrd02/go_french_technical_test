...
| ------------------------------------------------------------------ | -------------------------------- | ----------- | ------ |
| [SPEC-P2 — Analyse critique](specs/SPEC-P2-analyse-code.md)        | [tâches](tasks/TASKS-SPEC-P2.md) | Obligatoire | 20 min |
| [SPEC-06 — Config et qualité](specs/SPEC-06-config-qualite.md)     | [tâches](tasks/TASKS-SPEC-06.md) | Obligatoire | 12 min |
| [SPEC-02 — Intégration LLM](specs/SPEC-02-integration-llm.md)      | [tâches](tasks/TASKS-SPEC-02.md) | Obligatoire | 25 min |
| [SPEC-03 — Validation et retry](specs/SPEC-03-validation-retry.md) | [tâches](tasks/TASKS-SPEC-03.md) | Obligatoire | 20 min |
| [SPEC-01 — Contrat d'API](specs/SPEC-01-contrat-api.md)            | [tâches](tasks/TASKS-SPEC-01.md) | Obligatoire | 15 min |
| [SPEC-05 — Tests](specs/SPEC-05-tests.md)                          | [tâches](tasks/TASKS-SPEC-05.md) | Obligatoire | 25 min |
| [SPEC-04 — Validation métier](specs/SPEC-04-validation-metier.md)  | [tâches](tasks/TASKS-SPEC-04.md) | Recommandé  | 10 min |
| [SPEC-07 — Livrable et README](specs/SPEC-07-livrable.md)          |                                  | Obligatoire | 15 min |

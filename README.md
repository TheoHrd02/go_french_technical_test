...
**Un seul appel LLM pour les N questions, plutôt que N appels.** Contrepartie assumée : sur certains modèles, la qualité de la dernière question d'un gros lot peut être légèrement inférieure à celle d'un appel isolé. Le facteur 10 sur le coût ne justifie pas ce gain marginal.
...
**Travail individuel** — Theo Heredia, sur l'intégralité des parties 1 et 2.
